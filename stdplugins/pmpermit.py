...
BAALAJI_TG_USER_BOT = "PM tasidqlnamadi"
TG_COMPANION_USER_BOT = "Kut plis"
UNIBORG_USER_BOT_WARN_ZERO = "Offlineman spam qilma"
UNIBORG_USER_BOT_NO_WARN = "Salom iltimos meni kuting."
